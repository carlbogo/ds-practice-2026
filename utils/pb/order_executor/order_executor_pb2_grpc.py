...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in utils/pb/order_executor/order_executor_pb2_grpc.py depends on'
